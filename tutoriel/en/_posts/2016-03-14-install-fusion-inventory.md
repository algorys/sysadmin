...
[FusionInventory for GLPI](https://github.com/fusioninventory/fusioninventory-for-glpi) is a GLPI plugin used to collect data with agents [FusionInventory](http://fusioninventory.org/) installed on devices. It updates data in GLPI inventory and it's automatic.
...
To use this tutorial, you need a [GLPI server](/2016/03/glpi-install) and it's better to have the version `0.90.1` (the last stable release). Anyway, other versions of GLPI can work.
...
The windows installation is very simple. Download the client on the [dedicated page](http://forge.fusioninventory.org/projects/fusioninventory-agent-windows-installer/files) and choose the right `.exe`.
